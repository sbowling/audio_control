...
class Phaser(EffectBase):
    def __init__(self, master, client, config_file):
        super().__init__(master, client, config_file)
        self.geometry("400x300")
        self.label = ctk.CTkLabel(self.content_frame, text="Phaser Controls Placeholder", font=("Arial", 16))
        self.label.pack(expand=True)
...
class Wah(EffectBase):
    def __init__(self, master, client, config_file):
        super().__init__(master, client, config_file)
        self.geometry("400x300")
        self.label = ctk.CTkLabel(self.content_frame, text="Wah Controls Placeholder", font=("Arial", 16))
        self.label.pack(expand=True)
...
class Flanger(EffectBase):
    def __init__(self, master, client, config_file):
        super().__init__(master, client, config_file)
        self.geometry("400x300")
        self.label = ctk.CTkLabel(self.content_frame, text="Flanger Controls Placeholder", font=("Arial", 16))
        self.label.pack(expand=True)
